...
9. **JS budget.** `npm run build`; the student route's First Load JS delta must be ≤ 30 KB gzipped. **Measured: `/student` 111 kB and `/student/lessons/[id]` 112 kB against a 102 kB shared baseline — a 9–10 kB delta, comfortably inside budget.**
