...
WhatsApp integration · payments or Paystack · chat · video streaming · notice boards · live classes · auto-marking or quiz engine · multiple question difficulty tiers · analytics dashboards · attendance · timetable · admissions · multi-branch · local languages · voice narration · native mobile apps · score-driven revision recommendations (blocked until ResultPeak grades server-side)
